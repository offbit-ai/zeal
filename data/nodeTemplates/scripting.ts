...
export const scriptingTemplates: NodeTemplate[] = [
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input metadata in for Sandboxed JavaScript Runtime operation',
      },
      {
        id: 'result-out',
        label: 'Result',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Sandboxed JavaScript Runtime operation',
      },
    ],
    properties: {
      script: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input args in for Structured Shell Scripting operation',
      },
      {
        id: 'result-out',
        label: 'Result',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Structured Shell Scripting operation',
      },
    ],
    properties: {
      script: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Execute Python with pip packages operation',
      },
    ],
    properties: {
      script: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Database connection pool identifier from MySQL, PostgreSQL, or other SQL database nodes',
      },
      {
        id: 'params-in',
        label: 'Parameters',
        type: 'input',
        position: 'top',
        description: 'SQL query parameters for prepared statements and parameterized queries',
      },
      {
        id: 'result-out',
        label: 'Result',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Execute SQL queries operation',
      },
    ],
    properties: {
      query: {
