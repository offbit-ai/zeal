...
export const dataProcessingTemplates: NodeTemplate[] = [
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input schema in for High-Performance Data Processing operation',
      },
      {
        id: 'table-out',
        label: 'Arrow Table',
        type: 'output',
        position: 'right',
        description: 'Output table out from High-Performance Data Processing operation',
      },
      {
        id: 'stats-out',
        label: 'Statistics',
        type: 'output',
        position: 'bottom',
        description: 'Output stats out from High-Performance Data Processing operation',
      },
    ],
    properties: {
      operation: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output errors out from Parse CSV Files operation',
      },
    ],
    properties: {
      delimiter: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input schema in for Transform & Process Data operation',
      },
      {
        id: 'transformed-out',
        label: 'Transformed',
        type: 'output',
        position: 'right',
        description: 'Output transformed out from Transform & Process Data operation',
      },
      {
        id: 'errors-out',
        label: 'Errors',
        type: 'output',
        position: 'bottom',
        description: 'Output errors out from Transform & Process Data operation',
      },
    ],
    properties: {
      dataOperations: {
        ...
        description:
          'Configure data transformation pipelines including mapping, filtering, sorting, and aggregation',
      },
      errorHandling: {
        type: 'select',
        options: ['ignore', 'skip_item', 'stop_pipeline', 'log_and_continue'],
