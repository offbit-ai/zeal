...
export const aiModelsTemplates: NodeTemplate[] = [
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input tools in for AI Agent with Tools operation',
      },
      {
        id: 'result-out',
        label: 'Result',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output steps out from AI Agent with Tools operation',
      },
    ],
    properties: {
      agentType: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input input in for Custom Model Runner operation',
      },
      {
        id: 'config-in',
        label: 'Config',
      ...
      },
      {
        ...
        type: 'output',
        position: 'right',
        description: 'Output output out from Custom Model Runner operation',
      },
      {
        id: 'metadata-out',
        label: 'Metadata',
        type: 'output',
        position: 'bottom',
        description: 'Output metadata out from Custom Model Runner operation',
      },
    ],
    properties: {
      modelId: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input prompt in for Anthropic AI Assistant operation',
      },
      {
        id: 'context-in',
        label: 'Context',
        type: 'input',
        position: 'top',
        description: 'Input context in for Anthropic AI Assistant operation',
      },
      {
        id: 'response-out',
        label: 'Response',
        type: 'output',
        position: 'right',
        description: 'Output response out from Anthropic AI Assistant operation',
      },
      {
        id: 'usage-out',
        label: 'Usage',
        type: 'output',
        position: 'bottom',
        description: 'Output usage out from Anthropic AI Assistant operation',
      },
    ],
    properties: {
      model: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input prompt in for Google Gemini AI operation',
      },
      {
        id: 'media-in',
        label: 'Media',
        type: 'input',
        position: 'top',
        description: 'Input media in for Google Gemini AI operation',
      },
      {
        id: 'response-out',
        label: 'Response',
        type: 'output',
        position: 'right',
        description: 'Output response out from Google Gemini AI operation',
      },
      {
        id: 'analysis-out',
        label: 'Analysis',
        type: 'output',
        position: 'bottom',
        description: 'Output analysis out from Google Gemini AI operation',
      },
    ],
    properties: {
      model: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input prompt in for GPT-4 Language Model operation',
      },
      {
        id: 'context-in',
        label: 'Context',
        type: 'input',
        position: 'top',
        description: 'Input context in for GPT-4 Language Model operation',
      },
      {
        id: 'response-out',
        label: 'Response',
        type: 'output',
        position: 'right',
        description: 'Output response out from GPT-4 Language Model operation',
      },
      {
        id: 'usage-out',
        label: 'Usage',
        type: 'output',
        position: 'bottom',
        description: 'Output usage out from GPT-4 Language Model operation',
      },
    ],
    properties: {
      model: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input prompt in for Multi-Provider AI operation',
      },
      {
        id: 'context-in',
        label: 'Context',
        type: 'input',
        position: 'top',
        description: 'Input context in for Multi-Provider AI operation',
      },
      {
        id: 'response-out',
        label: 'Response',
        type: 'output',
        position: 'right',
        description: 'Output response out from Multi-Provider AI operation',
      },
      {
        id: 'usage-out',
        label: 'Usage & Cost',
        type: 'output',
        position: 'bottom',
        description: 'Output usage out from Multi-Provider AI operation',
      },
    ],
    properties: {
      provider: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input input in for Open Model Hub operation',
      },
      {
        id: 'params-in',
        label: 'Parameters',
      ...
      },
      {
        ...
        type: 'output',
        position: 'right',
        description: 'Output output out from Open Model Hub operation',
      },
      {
        id: 'stats-out',
        label: 'Stats',
        type: 'output',
        position: 'bottom',
        description: 'Output stats out from Open Model Hub operation',
      },
    ],
    properties: {
      taskType: {
