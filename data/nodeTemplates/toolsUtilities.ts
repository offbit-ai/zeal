    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input variables in for Execute GraphQL Operations operation',
      },
      {
        id: 'data-out',
        label: 'Data',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output errors out from Execute GraphQL Operations operation',
      },
    ],
    properties: {
      endpoint: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'input',
        position: 'top',
        description: 'Input headers in for Make HTTP API Calls operation',
      },
      {
        id: 'response-out',
        label: 'Response',
        type: 'output',
        position: 'right',
        description: 'Output response out from Make HTTP API Calls operation',
      },
      {
        id: 'error-out',
        label: 'Error',
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Make HTTP API Calls operation',
      },
    ],
    properties: {
      url: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Remote Procedure Call operation',
      },
    ],
    properties: {
      protocol: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input value in for |A| operation',
      },
      {
        id: 'result-out',
        label: 'Result',
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input a in for A + B operation',
      },
      {
        id: 'b-in',
        label: 'B',
        type: 'input',
        position: 'left',
        description: 'Input b in for A + B operation',
      },
      {
        id: 'result-out',
        label: 'Result',
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input array in for Calculate Mean operation',
      },
      {
        id: 'avg-out',
        label: 'Average',
        type: 'output',
        position: 'right',
        description: 'Output avg out from Calculate Mean operation',
      },
      {
        id: 'count-out',
        label: 'Count',
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input value in for Limit Range operation',
      },
      {
        id: 'min-in',
        label: 'Min',
        type: 'input',
        position: 'left',
        description: 'Input min in for Limit Range operation',
      },
      {
        id: 'max-in',
        label: 'Max',
        type: 'input',
        position: 'left',
        description: 'Input max in for Limit Range operation',
      },
      {
        id: 'result-out',
        label: 'Result',
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from A ÷ B operation',
      },
    ],
    properties: {
      precision: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input variables in for Evaluate Expression operation',
      },
      {
        id: 'result-out',
        label: 'Result',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from Evaluate Expression operation',
      },
    ],
    properties: {
      expression: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input array in for Find Min & Max operation',
      },
      {
        id: 'min-out',
        label: 'Min',
        type: 'output',
        position: 'top',
        description: 'Output min out from Find Min & Max operation',
      },
      {
        id: 'max-out',
        label: 'Max',
        type: 'output',
        position: 'right',
        description: 'Output max out from Find Min & Max operation',
      },
      {
        id: 'range-out',
        label: 'Range',
        type: 'output',
        position: 'bottom',
        description: 'Output range out from Find Min & Max operation',
      },
    ],
    properties: {},
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input base in for A ^ B operation',
      },
      {
        id: 'exp-in',
        label: 'Exponent',
        type: 'input',
        position: 'left',
        description: 'Input exp in for A ^ B operation',
      },
      {
        id: 'result-out',
        label: 'Result',
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input trigger in for Generate Random operation',
      },
      {
        id: 'value-out',
        label: 'Value',
        type: 'output',
        position: 'right',
        description: 'Output value out from Generate Random operation',
      },
    ],
    properties: {
      min: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input value in for Round Number operation',
      },
      {
        id: 'result-out',
        label: 'Result',
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output error out from √A operation',
      },
    ],
    properties: {
      precision: {
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        type: 'output',
        position: 'right',
        description: 'Output mean out from Statistical Analysis operation',
      },
      {
        id: 'median-out',
        label: 'Median',
        type: 'output',
        position: 'right',
        description: 'Output median out from Statistical Analysis operation',
      },
      {
        id: 'mode-out',
        label: 'Mode',
        type: 'output',
        position: 'right',
        description: 'Output mode out from Statistical Analysis operation',
      },
      {
        id: 'std-out',
        label: 'Std Dev',
        type: 'output',
        position: 'bottom',
        description: 'Output std out from Statistical Analysis operation',
      },
      {
        id: 'variance-out',
        label: 'Variance',
        type: 'output',
        position: 'bottom',
        description: 'Output variance out from Statistical Analysis operation',
      },
    ],
    properties: {
      precision: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input array in for Sum Array operation',
      },
      {
        id: 'sum-out',
        label: 'Sum',
        type: 'output',
        position: 'right',
        description: 'Output sum out from Sum Array operation',
      },
    ],
    properties: {
      ignoreNonNumeric: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input json in for Parse & Transform JSON operation',
      },
      {
        id: 'schema-in',
        label: 'Schema',
        type: 'input',
        position: 'top',
        description: 'Input schema in for Parse & Transform JSON operation',
      },
      {
        id: 'parsed-out',
        label: 'Parsed',
        type: 'output',
        position: 'right',
        description: 'Output parsed out from Parse & Transform JSON operation',
      },
      {
        id: 'errors-out',
        label: 'Errors',
        type: 'output',
        position: 'bottom',
        description: 'Output errors out from Parse & Transform JSON operation',
      },
    ],
    properties: {
      jsonPath: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input text in for Pattern Matching operation',
      },
      {
        id: 'pattern-in',
        label: 'Pattern',
        type: 'input',
        position: 'top',
        description: 'Input pattern in for Pattern Matching operation',
      },
      {
        id: 'matches-out',
        label: 'Matches',
        type: 'output',
        position: 'right',
        description: 'Output matches out from Pattern Matching operation',
      },
      {
        id: 'groups-out',
        label: 'Groups',
        type: 'output',
        position: 'bottom',
        description: 'Output groups out from Pattern Matching operation',
      },
    ],
    properties: {
      pattern: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input xml in for Parse XML Documents operation',
      },
      {
        id: 'xpath-in',
        label: 'XPath',
        type: 'input',
        position: 'top',
        description: 'Input xpath in for Parse XML Documents operation',
      },
      {
        id: 'data-out',
        label: 'Data',
      ...
      },
      {
        ...
        type: 'output',
        position: 'bottom',
        description: 'Output errors out from Parse XML Documents operation',
      },
    ],
    properties: {
      xpath: {
    ...
    ports: [
      {
        ...
        type: 'input',
        position: 'left',
        description: 'Input date in for Date Operations operation',
      },
      {
        id: 'formatted-out',
        label: 'Formatted',
        type: 'output',
        position: 'right',
        description: 'Output formatted out from Date Operations operation',
      },
      {
        id: 'timestamp-out',
        label: 'Timestamp',
        type: 'output',
        position: 'bottom',
        description: 'Output timestamp out from Date Operations operation',
      },
    ],
    properties: {
      operation: {
