...
import {
  ...
  FaSnapchat, FaPinterest, FaReddit, FaDiscord, FaTelegram, FaWhatsapp,
  // Tech Companies  
  FaGoogle, FaMicrosoft, FaApple, FaAmazon, FaGithub, FaGitlab,
  FaSlack, FaDropbox, FaTrello,
  // Development
  FaReact, FaVuejs, FaAngular, FaNodeJs, FaPython, FaJava,
  FaJs, FaHtml5, FaCss3, FaDocker, FaAws, FaDigitalOcean,
  // Others
  FaStripe, FaPaypal, FaSpotify, FaUber, FaAirbnb,
  FaSalesforce, FaShopify, FaWordpress, FaMailchimp, FaFileExcel
} from 'react-icons/fa'

import {
  // Additional brand icons from other react-icons sets
  SiOpenai, SiClaude, SiMongodb, SiPostgresql, SiMysql, SiRedis,
  SiElasticsearch, SiRabbitmq, SiGraphql,
  SiTensorflow, SiPytorch, SiKeras, SiScipy, SiNumpy, SiPandas,
  SiJupyter, SiTableau, SiLooker, SiDbt, SiAsana, SiZoom, SiHubspot,
  SiSnowflake, SiDatabricks, SiApacheairflow, SiAmazons3, SiKubernetes, SiTerraform,
  SiJenkins, SiGithubactions, SiCircleci, SiTravisci,
  SiPrometheus, SiGrafana, SiDatadog, SiNewrelic, SiSentry,
 ...
 */
export function getBrandIconsByCategory(category: keyof typeof BrandIcons): Record<string, React.ComponentType<BrandIconProps>> {
