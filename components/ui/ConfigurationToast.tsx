...
export function ConfigurationToast({
  nodeMetadata,
  onConfigure,
  onDismiss,
}: ConfigurationToastProps) {
  ...
  return (
    <div
      className={`fixed bottom-4 right-4 max-w-sm bg-white border border-orange-200 rounded-lg shadow-lg p-4 transition-all duration-300 ease-out z-50 ${
