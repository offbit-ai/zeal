...
export function GroupCreationModal({ 
  ...
  const shortcutKey = isMac ? '⌘G' : 'Ctrl+G'

  useEffect(() => {
    if (isOpen) {
      // Auto-generate default values when modal opens
      setTitle(`Group of ${selectedNodeCount} nodes`)
      setDescription(`Contains: ${selectedNodeNames.join(', ')}`)
    }
  }, [isOpen, selectedNodeCount, selectedNodeNames])
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 animate-in fade-in duration-200">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Create Node Group</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-3">
              <h4 className="text-xs font-medium text-gray-700 mb-2">Selected Nodes:</h4>
