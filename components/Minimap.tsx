...
export function Minimap({
  ...
  const worldRight = Math.max(
    bounds.maxX + worldPadding,
    -canvasOffset.x + viewportSize.width + worldPadding
  )
  const worldBottom = Math.max(
    bounds.maxY + worldPadding,
    -canvasOffset.y + viewportSize.height + worldPadding
  )
      ...
      >
            ...
            <div
              ...
              style={{
                ...
                backgroundColor: group.collapsed
                  ? group.color
                    ? `${group.color}40`
                    : 'rgba(156, 163, 175, 0.25)' // Higher opacity when collapsed
                  : group.color
                    ? `${group.color}20`
                    : 'rgba(156, 163, 175, 0.1)', // Lower opacity when expanded
        ...
        {(() => {
          const filteredNodes = nodes.filter(node => {
            ...
            const isInCollapsedGroup = groups.some(
