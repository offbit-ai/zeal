    ...
    details: {
      dataPayload: {
        ...
        output: trace.status === 'success' ? {
          ...
          sample: '{"processed": true, "result": "Success", "timestamp": "2024-01-15T10:30:00Z"}'
        } : null,
...
export const PUT = withErrorHandling(async (req: NextRequest, { params }: { params: { id: string } }) => {
  ...
  const updatedTrace = {
    ...
    errorMessage: body.errorMessage !== undefined ? body.errorMessage : existingTrace.errorMessage,
